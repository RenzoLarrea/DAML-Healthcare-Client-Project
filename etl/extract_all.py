...
if __name__ == "__main__":
    ...
    if not bundles:
        ...
        print("Total ExplanationOfBenefit resources extracted:", len(resources))

        # ✅ Save raw JSON resources for clean reprocessing later
        with open("data/eob_raw_resources.json", "w", encoding="utf-8") as f:
            json.dump(resources, f, ensure_ascii=False, indent=2)

        print("Saved raw EOB JSON to data/eob_raw_resources.json")